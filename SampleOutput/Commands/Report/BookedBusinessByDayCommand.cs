...
namespace SampleOutput.Commands.Report
{
    ...
    public record struct BookedBusinessByDay_Command(DateTime? StartDate, DateTime? EndDate) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[Report].[BookedBusinessByDay]";

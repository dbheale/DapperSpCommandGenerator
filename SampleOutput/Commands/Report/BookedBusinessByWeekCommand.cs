...
namespace SampleOutput.Commands.Report
{
    ...
    public record struct BookedBusinessByWeek_Command(DateTime? StartDate, DateTime? EndDate) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[Report].[BookedBusinessByWeek]";

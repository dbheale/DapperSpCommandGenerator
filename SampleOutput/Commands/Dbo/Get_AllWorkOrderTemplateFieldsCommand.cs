...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Get_AllWorkOrderTemplateFields_Command(int WorkOrderTemplateId) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Get_AllWorkOrderTemplateFields]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_FieldValues_Command(int FieldId, string? Label, string? Value) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_FieldValues]";

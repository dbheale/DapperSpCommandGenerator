...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Delete_MediaOutletContactTypes_Command(int Id) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Delete_MediaOutletContactTypes]";

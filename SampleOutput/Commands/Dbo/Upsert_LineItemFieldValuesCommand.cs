...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Upsert_LineItemFieldValues_Command(int LineItemId, int FieldId, string? Value) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Upsert_LineItemFieldValues]";
        ...
        {
            return $"LineItemId:{LineItemId}, FieldId:{FieldId}, Value:{Value}";
        }
    }
}
...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Delete_WorkOrderTemplateSheets_Command(int Id) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Delete_WorkOrderTemplateSheets]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_WorkOrderTypes_Command(string? Name, string? Description) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_WorkOrderTypes]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_FieldHeaders_Command(int Id, string? Label, int Order) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_FieldHeaders]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Get_WorkOrderLineItemValues_Command(int WorkOrderId) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Get_WorkOrderLineItemValues]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_WorkOrderTemplateSheets_Command(string? SheetName, int RowIndex, string? ColumnName, int SortOrder) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_WorkOrderTemplateSheets]";
        ...
        {
            return $"SheetName:{SheetName}, RowIndex:{RowIndex}, ColumnName:{ColumnName}, SortOrder:{SortOrder}";
        }
    }
}
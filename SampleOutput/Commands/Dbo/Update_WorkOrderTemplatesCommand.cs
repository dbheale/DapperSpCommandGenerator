...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_WorkOrderTemplates_Command(int Id, string? Name, string? Description, string? Filename) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_WorkOrderTemplates]";
        ...
        {
            return $"Id:{Id}, Name:{Name}, Description:{Description}, Filename:{Filename}";
        }
    }
}
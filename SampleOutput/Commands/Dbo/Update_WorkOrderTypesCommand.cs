...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_WorkOrderTypes_Command(int Id, string? Name, string? Description) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_WorkOrderTypes]";

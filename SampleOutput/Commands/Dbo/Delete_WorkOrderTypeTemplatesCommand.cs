...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Delete_WorkOrderTypeTemplates_Command(int WorkOrderTypeId, int WorkOrderTemplateId) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Delete_WorkOrderTypeTemplates]";

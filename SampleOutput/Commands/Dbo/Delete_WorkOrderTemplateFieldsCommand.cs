...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Delete_WorkOrderTemplateFields_Command(int Id) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Delete_WorkOrderTemplateFields]";

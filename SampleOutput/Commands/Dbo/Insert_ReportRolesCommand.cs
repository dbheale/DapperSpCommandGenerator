...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_ReportRoles_Command(int ReportId, int RoleId) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_ReportRoles]";
        ...
        {
            return $"ReportId:{ReportId}, RoleId:{RoleId}";
        }
    }
}
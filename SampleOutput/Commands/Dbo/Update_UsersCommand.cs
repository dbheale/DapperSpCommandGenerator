...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_Users_Command(int Id, int ContactId, string? Upn, string? Sid) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_Users]";
        ...
        {
            return $"Id:{Id}, ContactId:{ContactId}, Upn:{Upn}, Sid:{Sid}";
        }
    }
}
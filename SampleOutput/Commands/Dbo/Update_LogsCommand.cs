...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_Logs_Command(int Id, string? Message, string? MessageTemplate, string? Level, DateTime? TimeStamp, string? Exception, string? Properties) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_Logs]";
        ...
        {
            return $"Id:{Id}, Message:{Message}, MessageTemplate:{MessageTemplate}, Level:{Level}, TimeStamp:{TimeStamp}, Exception:{Exception}, Properties:{Properties}";
        }
    }
}
...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_WorkOrderStatus_Command(string? Label, string? Description) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_WorkOrderStatus]";

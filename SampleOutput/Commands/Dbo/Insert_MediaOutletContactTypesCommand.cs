...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Insert_MediaOutletContactTypes_Command(int Id, string? Name, string? Description) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Insert_MediaOutletContactTypes]";

...
namespace SampleOutput.Commands.Dbo
{
    ...
    public record struct Update_MediaOutletContactTypes_Command(int Id, string? Name, string? Description) : IDatabaseCommand
    {
        ...
        public string GetStoredProcedure() => "[dbo].[Update_MediaOutletContactTypes]";

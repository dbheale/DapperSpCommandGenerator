...
{
    public record Update_Logs_Command(int Id, string? Message, string? MessageTemplate, string? Level, DateTime? TimeStamp, string? Exception, string? Properties) : IDatabaseCommand
    {

...
{
    public record Update_Fields_Command(int Id, string? Name, string? Description, string? Label, int FieldTypeId, string? LabelFormula, string? Formula, bool? ReadOnly, int RoleId) : IDatabaseCommand
    {

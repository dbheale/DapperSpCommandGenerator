...
{
    public record Update_LineItemFieldValues_Command(long? Id, int LineItemId, int FieldId, string? Value) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Update_LineItemFieldValues]";

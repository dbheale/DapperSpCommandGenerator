...
{
    public record Get_WorkOrderTypeTemplates_Command(int WorkOrderTypeId, int WorkOrderTemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_WorkOrderTypeTemplates]";

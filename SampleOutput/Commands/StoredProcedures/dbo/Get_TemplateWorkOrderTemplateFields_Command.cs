...
{
    public record Get_TemplateWorkOrderTemplateFields_Command(int WorkOrderTemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_TemplateWorkOrderTemplateFields]";
        ...
        {
            return $"WorkOrderTemplateId:{WorkOrderTemplateId}";
        }
    }
}
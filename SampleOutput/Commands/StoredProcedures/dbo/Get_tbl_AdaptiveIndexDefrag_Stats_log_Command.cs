...
{
    public record Get_tbl_AdaptiveIndexDefrag_Stats_log_Command(int statsUpdate_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_Stats_log]";

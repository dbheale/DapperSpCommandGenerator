...
{
    public record Update_TemplateSheets_Command(int Id, string? SheetName, int RowIndex, string? ColumnName, int SortOrder, int TemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Update_TemplateSheets]";
        ...
        {
            return $"Id:{Id}, SheetName:{SheetName}, RowIndex:{RowIndex}, ColumnName:{ColumnName}, SortOrder:{SortOrder}, TemplateId:{TemplateId}";
        }
    }
}
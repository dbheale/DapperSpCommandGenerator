...
{
    public record Get_AllTemplateFields_Command(int UserId, int TemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_AllTemplateFields]";
        ...
        {
            return $"UserId:{UserId}, TemplateId:{TemplateId}";
        }
    }
}
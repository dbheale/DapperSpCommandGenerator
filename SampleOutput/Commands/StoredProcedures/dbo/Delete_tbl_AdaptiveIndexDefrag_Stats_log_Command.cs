...
{
    public record Delete_tbl_AdaptiveIndexDefrag_Stats_log_Command(int statsUpdate_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_Stats_log]";
        ...
        {
            return $"statsUpdate_id:{statsUpdate_id}";
        }
    }
}
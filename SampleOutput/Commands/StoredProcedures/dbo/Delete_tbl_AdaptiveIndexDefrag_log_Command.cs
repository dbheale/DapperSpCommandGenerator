...
{
    public record Delete_tbl_AdaptiveIndexDefrag_log_Command(int indexDefrag_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_log]";
        ...
        {
            return $"indexDefrag_id:{indexDefrag_id}";
        }
    }
}
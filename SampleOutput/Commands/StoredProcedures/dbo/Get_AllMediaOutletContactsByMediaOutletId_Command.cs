...
{
    public record Get_AllMediaOutletContactsByMediaOutletId_Command(int MediaOutletId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_AllMediaOutletContactsByMediaOutletId]";
        ...
        {
            return $"MediaOutletId:{MediaOutletId}";
        }
    }
}
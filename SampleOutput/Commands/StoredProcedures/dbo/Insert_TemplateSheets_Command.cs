...
{
    public record Insert_TemplateSheets_Command(string? SheetName, int RowIndex, string? ColumnName, int SortOrder, int TemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_TemplateSheets]";
        ...
        {
            return $"SheetName:{SheetName}, RowIndex:{RowIndex}, ColumnName:{ColumnName}, SortOrder:{SortOrder}, TemplateId:{TemplateId}";
        }
    }
}
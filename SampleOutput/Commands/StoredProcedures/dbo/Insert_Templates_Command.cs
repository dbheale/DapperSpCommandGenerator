...
{
    public record Insert_Templates_Command(string? Name, string? Description, string? Filename, bool? IsWorkOrderTemplate, bool? IsCampaignTemplate) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_Templates]";
        ...
        {
            return $"Name:{Name}, Description:{Description}, Filename:{Filename}, IsWorkOrderTemplate:{IsWorkOrderTemplate}, IsCampaignTemplate:{IsCampaignTemplate}";
        }
    }
}
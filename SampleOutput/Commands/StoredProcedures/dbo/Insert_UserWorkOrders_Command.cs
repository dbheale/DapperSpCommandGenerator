...
{
    public record Insert_UserWorkOrders_Command(int UserId, int WorkOrderId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_UserWorkOrders]";
        ...
        {
            return $"UserId:{UserId}, WorkOrderId:{WorkOrderId}";
        }
    }
}
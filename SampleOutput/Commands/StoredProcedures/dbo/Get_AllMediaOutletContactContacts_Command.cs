...
{
    public record Get_AllMediaOutletContactContacts_Command(int MediaOutletId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_AllMediaOutletContactContacts]";

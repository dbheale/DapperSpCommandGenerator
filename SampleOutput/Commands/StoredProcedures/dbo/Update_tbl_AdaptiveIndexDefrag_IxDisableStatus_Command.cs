...
{
    public record Update_tbl_AdaptiveIndexDefrag_IxDisableStatus_Command(int disable_id, int dbID, int objectID, int indexID, bool? is_disabled, DateTime? dateTimeChange) : IDatabaseCommand
    {
        public DynamicParameters GetParameters()
        {
            var p = new DynamicParameters();
            p.Add("disable_id", disable_id);
			p.Add("dbID", dbID);
        ...
        public string GetSqlStatement() => "[dbo].[Update_tbl_AdaptiveIndexDefrag_IxDisableStatus]";
        ...
        {
            return $"disable_id:{disable_id}, dbID:{dbID}, objectID:{objectID}, indexID:{indexID}, is_disabled:{is_disabled}, dateTimeChange:{dateTimeChange}";
        }
    }
}
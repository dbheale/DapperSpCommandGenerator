...
{
    public record Get_RepositoryFile_Tags_Command(int RepositoryFileId, int TagId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_RepositoryFile_Tags]";

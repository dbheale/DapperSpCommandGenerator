...
{
    public record Get_tbl_AdaptiveIndexDefrag_log_Command(int indexDefrag_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_log]";

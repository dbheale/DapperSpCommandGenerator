...
{
    public record Get_AllMediaOutletCirculations_Command(int MediaOutletId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_AllMediaOutletCirculations]";

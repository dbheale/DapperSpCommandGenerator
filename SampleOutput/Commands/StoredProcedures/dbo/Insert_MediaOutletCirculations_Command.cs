...
{
    public record Insert_MediaOutletCirculations_Command(int MediaOutletId, string? PublishDays, string? PublishSchedule, int CirculationForSchedule, string? CirculationLabel) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_MediaOutletCirculations]";
        ...
        {
            return $"MediaOutletId:{MediaOutletId}, PublishDays:{PublishDays}, PublishSchedule:{PublishSchedule}, CirculationForSchedule:{CirculationForSchedule}, CirculationLabel:{CirculationLabel}";
        }
    }
}
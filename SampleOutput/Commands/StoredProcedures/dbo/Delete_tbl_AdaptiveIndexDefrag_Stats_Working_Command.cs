...
{
    public record Delete_tbl_AdaptiveIndexDefrag_Stats_Working_Command(int dbID, int objectID, int statsID, short? partitionNumber) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_Stats_Working]";

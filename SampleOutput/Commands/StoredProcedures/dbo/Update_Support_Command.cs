...
{
    public record Update_Support_Command(int Id, string? Title, string? Description, string? HtmlContent, int SortOrder) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Update_Support]";
        ...
        {
            return $"Id:{Id}, Title:{Title}, Description:{Description}, HtmlContent:{HtmlContent}, SortOrder:{SortOrder}";
        }
    }
}
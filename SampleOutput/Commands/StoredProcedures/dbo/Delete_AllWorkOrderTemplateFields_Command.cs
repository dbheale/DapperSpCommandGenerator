...
{
    public record Delete_AllWorkOrderTemplateFields_Command(int WorkOrderTemplateId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_AllWorkOrderTemplateFields]";

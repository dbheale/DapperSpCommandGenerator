...
{
    public record Delete_tbl_AdaptiveIndexDefrag_IxDisableStatus_Command(int disable_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_IxDisableStatus]";

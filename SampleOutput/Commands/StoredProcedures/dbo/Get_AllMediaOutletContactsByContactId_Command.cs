...
{
    public record Get_AllMediaOutletContactsByContactId_Command(int ContactId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_AllMediaOutletContactsByContactId]";

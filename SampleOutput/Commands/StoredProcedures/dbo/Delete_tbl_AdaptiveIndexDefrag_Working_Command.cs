...
{
    public record Delete_tbl_AdaptiveIndexDefrag_Working_Command(int dbID, int objectID, int indexID, short? partitionNumber) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_Working]";
        ...
        {
            return $"dbID:{dbID}, objectID:{objectID}, indexID:{indexID}, partitionNumber:{partitionNumber}";
        }
    }
}
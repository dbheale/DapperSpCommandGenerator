...
{
    public record Update_Templates_Command(int Id, string? Name, string? Description, string? Filename, bool? IsWorkOrderTemplate, bool? IsCampaignTemplate) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Update_Templates]";
        ...
        {
            return $"Id:{Id}, Name:{Name}, Description:{Description}, Filename:{Filename}, IsWorkOrderTemplate:{IsWorkOrderTemplate}, IsCampaignTemplate:{IsCampaignTemplate}";
        }
    }
}
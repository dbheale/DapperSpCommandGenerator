...
{
    public record Upsert_MediaOutletContact_Command(int ContactId, int MediaOutletId, int MediaOutletContactTypeId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Upsert_MediaOutletContact]";
        ...
        {
            return $"ContactId:{ContactId}, MediaOutletId:{MediaOutletId}, MediaOutletContactTypeId:{MediaOutletContactTypeId}";
        }
    }
}
...
{
    public record Insert_RepositoryFile_Tags_Command(int RepositoryFileId, int TagId) : IDatabaseCommand
    {
        public DynamicParameters GetParameters()
        {
            var p = new DynamicParameters();
            p.Add("RepositoryFileId", RepositoryFileId);
			p.Add("TagId", TagId);
            return p;
        }
        ...
        public string GetSqlStatement() => "[dbo].[Insert_RepositoryFile_Tags]";
        ...
        {
            return $"RepositoryFileId:{RepositoryFileId}, TagId:{TagId}";
        }
    }
}
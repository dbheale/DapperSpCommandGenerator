...
{
    public record Insert_tbl_AdaptiveIndexDefrag_Stats_Working_Command(int dbID, int objectID, int statsID, short? partitionNumber, string? dbName, string? schemaName, string? objectName, string? statsName, bool? no_recompute, bool? is_incremental, DateTime? scanDate, DateTime? updateDate, bool? printStatus) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_tbl_AdaptiveIndexDefrag_Stats_Working]";

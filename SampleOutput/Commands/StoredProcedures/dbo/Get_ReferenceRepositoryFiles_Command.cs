...
{
    public record Get_ReferenceRepositoryFiles_Command(int ReferenceId, int ReferenceTypeId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_ReferenceRepositoryFiles]";
        ...
        {
            return $"ReferenceId:{ReferenceId}, ReferenceTypeId:{ReferenceTypeId}";
        }
    }
}
...
{
    public record Get_tbl_AdaptiveIndexDefrag_Working_Command(int dbID, int objectID, int indexID, short? partitionNumber) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_Working]";

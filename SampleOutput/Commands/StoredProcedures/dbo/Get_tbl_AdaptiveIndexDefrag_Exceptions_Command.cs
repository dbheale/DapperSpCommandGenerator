...
{
    public record Get_tbl_AdaptiveIndexDefrag_Exceptions_Command(int dbID, int objectID, int indexID) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_Exceptions]";

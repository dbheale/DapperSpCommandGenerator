...
{
    public record Get_tbl_AdaptiveIndexDefrag_Analysis_log_Command(int analysis_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_Analysis_log]";

...
{
    public record Update_Campaign_Command(int Id, int ClientContactId, DateTime? StartDate, DateTime? EndDate, string? Notes, string? Lead, string? Company, string? LineOfBusiness) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Update_Campaign]";
        ...
        {
            return $"Id:{Id}, ClientContactId:{ClientContactId}, StartDate:{StartDate}, EndDate:{EndDate}, Notes:{Notes}, Lead:{Lead}, Company:{Company}, LineOfBusiness:{LineOfBusiness}";
        }
    }
}
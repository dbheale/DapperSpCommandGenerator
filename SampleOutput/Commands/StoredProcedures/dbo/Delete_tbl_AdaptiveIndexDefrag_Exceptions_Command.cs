...
{
    public record Delete_tbl_AdaptiveIndexDefrag_Exceptions_Command(int dbID, int objectID, int indexID) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_tbl_AdaptiveIndexDefrag_Exceptions]";
        ...
        {
            return $"dbID:{dbID}, objectID:{objectID}, indexID:{indexID}";
        }
    }
}
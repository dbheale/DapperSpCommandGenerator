...
{
    public record Get_tbl_AdaptiveIndexDefrag_IxDisableStatus_Command(int disable_id) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Get_tbl_AdaptiveIndexDefrag_IxDisableStatus]";

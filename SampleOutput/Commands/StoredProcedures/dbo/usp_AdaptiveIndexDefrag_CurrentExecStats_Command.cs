...
{
    public record usp_AdaptiveIndexDefrag_CurrentExecStats_Command(string? dbname) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[usp_AdaptiveIndexDefrag_CurrentExecStats]";

...
{
    public record Insert_tbl_AdaptiveIndexDefrag_Exceptions_Command(int dbID, int objectID, int indexID, string? dbName, string? objectName, string? indexName, int exclusionMask) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Insert_tbl_AdaptiveIndexDefrag_Exceptions]";

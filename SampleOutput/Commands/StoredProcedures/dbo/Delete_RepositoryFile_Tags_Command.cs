...
{
    public record Delete_RepositoryFile_Tags_Command(int RepositoryFileId, int TagId) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[dbo].[Delete_RepositoryFile_Tags]";

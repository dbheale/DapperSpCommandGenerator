...
{
    public record BookedBusiness_Command(int UserId, string? Company, DateTime? StartDate, DateTime? EndDate) : IDatabaseCommand
    {
        ...
        public string GetSqlStatement() => "[Report].[BookedBusiness]";
